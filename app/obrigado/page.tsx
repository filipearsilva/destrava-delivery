    ...
    <main className="min-h-screen overflow-hidden bg-[#0d0b07] text-[#f7f2e9]">
      <header className="border-b border-[#3b2d1b] bg-[#0d0b07]/95 px-6 py-5">
        <div className="mx-auto flex max-w-7xl items-center justify-between">
          ...
          <span className="hidden rounded-full border border-[#5a431d] px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-[#d7a72b] sm:block">Compra confirmada</span>
        </div>
      </header>
