    ...
    <main className="min-h-screen overflow-hidden bg-[#0d0b07] text-[#f7f2e9]">
      <header className="border-b border-[#3b2d1b] bg-[#0d0b07]/95 px-6 py-5">
        <div className="mx-auto flex max-w-7xl items-center justify-between">
          ...
          <span className="hidden items-center gap-2 rounded-full border border-[#5a431d] px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-[#d7a72b] sm:flex"><span className="grid size-5 place-items-center rounded-full bg-[#f4b82b] text-[11px] font-black text-[#151006]"><Check size={14} strokeWidth={3} aria-hidden="true" /></span>Compra confirmada</span>
        </div>
      </header>
      ...
      <section className="relative mx-auto grid max-w-7xl items-center gap-12 px-6 pb-20 pt-14 lg:grid-cols-[0.9fr_1.1fr] lg:pb-28 lg:pt-24">
        <div className="relative z-10">
          <div className="mb-5 flex items-center gap-3 text-sm font-bold uppercase tracking-[0.28em] text-[#f4b82b]"><span className="grid size-8 place-items-center rounded-full bg-[#f4b82b] text-lg font-black text-[#151006] shadow-[0_0_24px_rgba(244,184,43,0.35)]"><Check size={20} strokeWidth={3} aria-hidden="true" /></span><span>Sua vaga está garantida</span></div>
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[1.15fr_0.85fr]">
          ...
          <div>
            ...
            <ul className="mt-8 space-y-4 text-[#eee6d8]">
              {["Caderno para suas ideias e decisões", "Garrafa para acompanhar os dois dias", "Ingresso e credencial do evento", "Materiais exclusivos do Destrava Delivery"].map((item) => <li key={item} className="flex items-center gap-3"><span className="grid size-7 place-items-center rounded-full bg-[#f4b82b] text-[#151006]"><Check size={17} strokeWidth={3} aria-hidden="true" /></span><span>{item}</span></li>)}
            </ul>
          </div>
        </div>
      </section>
